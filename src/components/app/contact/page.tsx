        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed md:text-xl">
              Có câu hỏi hoặc cần tư vấn? Đội ngũ của chúng tôi luôn sẵn sàng hỗ trợ bạn.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="mb-8 text-muted-foreground leading-relaxed">
                  Hãy liên hệ với chúng tôi qua bất kỳ kênh nào thuận tiện nhất cho bạn. Chúng tôi cam kết phản hồi
                  trong vòng 24 giờ.
                </p>
              </div>
                ...
                <Card>
                  <CardContent className="flex items-start gap-4 p-6">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">contact@viettech.com</p>
                      <p className="text-muted-foreground">support@viettech.com</p>
                    </div>
                  </CardContent>
                </Card>
