        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed md:text-xl">
              Linh hoạt, minh bạch và không có chi phí ẩn. Nâng cấp hoặc hạ cấp
              bất cứ lúc nào.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  answer:
                    "Chúng tôi chấp nhận chuyển khoản ngân hàng, thẻ tín dụng/ghi nợ và các ví điện tử phổ biến.",
                },
                {
                  question: "Có hỗ trợ dùng thử miễn phí không?",
                  answer:
                    "Có, tất cả các gói đều có 14 ngày dùng thử miễn phí, không cần thẻ tín dụng.",
                },
              ].map((faq, index) => (
                <Card key={index}>
